...
namespace ZombieKiller
{
	...
	{
		public LevelOne (GraphicsContext g, Collisions c, Player plr) : base(g, new Texture2D("/Application/Assets/Levels/background.png", false), c, 1, 20, 50, "Level One", plr)
		{
			MaxEnemies = 60;
		...
		public override void SpawnEnemies ()
		{
			for (int i = 0; i < MaxEnemies - EnemyCount; i++) {
				Enemy e;
				e = new Zombie (Graphics, new Vector3 (400 + rnd.Next (200, 400), 450 + rnd.Next (-400, 401), 0), Collide, Difficulty);
				e.Player = Collide.P;
