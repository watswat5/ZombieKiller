...
namespace ZombieKiller
{
	...
	{
		public LevelFour (GraphicsContext g, Collisions c, Player plr) : base(g, new Texture2D("/Application/Assets/Levels/grassfield.png", false), c, 3, 20, 50, "Level One", plr)
		{
			MaxEnemies = 60;
			c.P = plr;
		...
		public override void Drop(Enemy e)
		{
			...
			if(drops.Count != 0)
			{
				...
				case 5:
					...
					break;
				case 6:
					it = new RPGObject(Graphics, e.p.Position, Collide);
					Collide.AddItem = it;
					break;
				case 7:
					it = new RPGAmmo(Graphics, e.p.Position, Collide);
					Collide.AddItem = it;
					break;
				default:
					break;
